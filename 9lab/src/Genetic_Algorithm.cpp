...
void Genetic_Algorithm::Input(string ar, string grid){
	...
	//probability of mutation and cross-over
...
void Genetic_Algorithm::PrintSolution(void){
	ofstream out;
